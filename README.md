...
* **Amazon.es** ──► Script Python (Playwright)
* **GitHub Actions** (12:00 PM) ──► Actualiza `historial_precios.csv` y `grafico_precios.png`
* **App Móvil Android** ──► Descarga datos vía OkHttp (Jetpack Compose + Coil + MVVM)
...
1. Clonar el repositorio: `git clone https://github.com/YoEl002/rastreador-precios.git`
2. Entrar a la carpeta: `cd rastreador-precios`
3. Instalar dependencias: `pip install playwright pandas matplotlib`
4. Instalar navegadores de Playwright: `playwright install chromium`
5. Ejecutar el rastreador: `python rastreador.py`
